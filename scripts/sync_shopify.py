...
def generate_sitemap(products):
    ...
    STATIC = [
        ...
        ("/blog", "weekly", "0.7"),
        ("/blog/vertus-pierres-naturelles", "monthly", "0.6"),
        ("/blog/meditation-debutants", "monthly", "0.6"),
        ("/blog/choisir-bracelet-zen", "monthly", "0.6"),
        ("/blog/symboles-bouddhistes-sens", "monthly", "0.6"),
        ("/blog/purifier-pierres-naturelles", "monthly", "0.6"),
        ("/contact", "monthly", "0.5"),
        ("/a-propos", "monthly", "0.6"),
        ("/livraison", "monthly", "0.5"),
        ("/faq", "monthly", "0.7"),
        # Collections Shopify (une fois catégorisées)
        ("/collections/bracelets", "weekly", "0.7"),
        ("/collections/bracelets-de-cheville", "weekly", "0.6"),
        ("/collections/collier-pendantif", "weekly", "0.7"),
        ("/collections/boucles-doreilles", "weekly", "0.6"),
        ("/collections/bagues", "weekly", "0.6"),
        ("/collections/pierres", "weekly", "0.7"),
        ("/collections/bols-chantants-tibetains", "weekly", "0.6"),
        ("/collections/bruleurs-et-encens", "weekly", "0.6"),
        ("/collections/decoration-zen", "weekly", "0.6"),
        ("/collections/malas-bouddhiste", "weekly", "0.6"),
        ("/collections/chakras", "weekly", "0.6"),
        ("/collections/oeufs-de-yoni", "weekly", "0.5"),
        ("/collections/pendules", "weekly", "0.5"),
        ("/collections/porte-cles", "weekly", "0.5"),
        ("/collections/bouddha", "weekly", "0.6"),
        ("/collections/vetement", "weekly", "0.5"),
        ("/collections/ambiance-lampes", "weekly", "0.5"),
        ("/collections/aromatherapie", "weekly", "0.5"),
        ("/collections/orgonites", "weekly", "0.5"),
        ("/collections/tableaux-et-peintures", "weekly", "0.5"),
        ("/collections/toiles-tapisseries-et-mandala", "weekly", "0.5"),
    ]
    urls = []
